...
public class Constants {
    ...
    public static final String UNAUTHORIZED_MESSAGE = "UNAUTHORIZED: пользователь не авторизован";
    public static final String INTERNAL_SERVER_ERROR = "INTERNAL_SERVER_ERROR: Ошибка сервера при обработке запроса";
    ...
    public static final String CAR_FOUND_SUCCESS_MESSAGE = "Машина успешно найдена. Может вернуть пустой список если машины не найдены.";
