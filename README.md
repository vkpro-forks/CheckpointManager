...
1. **Переход на Сайт** [сайт Checkpoint Manager](URL_сайта).
...
<p float="left">
  <img alt="Ввод электронной почты" src="F:\несистемная папка\AnvilCoder\чекпон\стартовая форма фигма.png" height="350" width="350" style="margin-right: 50px;"/>
  <img alt="Выбор готового акка" src="F:\несистемная папка\AnvilCoder\чекпон\стартовая форма 2.png" height="350" width="350"/>
</p>
...
<img alt="Форма входа" height="400" src="F:\несистемная папка\AnvilCoder\чекпон\логин.png" width="400"/>
...
<p float="left">
  <img alt="Форма регистрации" src="F:\несистемная папка\AnvilCoder\чекпон\регистрация.png" height="400" width="400" style="margin-right: 50px;"/>
  <img alt="Письмо" src="F:\несистемная папка\AnvilCoder\чекпон\письмо короткое.png" height="400" width="400"/>
</p>
...
<img alt="Главный интерфейс Checkpoint Manager" height="400" src="F:\несистемная папка\AnvilCoder\чекпон\главная список пропусков.png" width="900"/>
...
<img alt="Создание пропуска" height="400" src="F:\несистемная папка\AnvilCoder\чекпон\создание пропуска.png" width="600"/>
...
<img alt="О пропуске" height="400" src="F:\несистемная папка\AnvilCoder\чекпон\о пропуске.png" width="900"/>


n. **Помощь и Поддержка**:
